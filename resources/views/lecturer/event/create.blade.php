...
<div class=" rounded-3xl bg-slate-100 py-10">
    ...
    <div class="  rounded-3xl bg-slate-50 shadow-lg overflow-hidden">
        ...
        <form method="POST"action="{{ route('lecturer.events.store') }}"enctype="multipart/form-data"class="space-y-8">
                        ...
                        <div>
                            ...
                            <div class="rounded-xl bg-yellow-100 border border-yellow-300 p-4">
                                ...
                                <p class="text-sm text-yellow-700 mt-1">
                                    ...
                                    Your event will be reviewed by the admin before it becomes visible to everyone.
